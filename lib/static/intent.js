...
class Intent
{
	...
	clone()
	{
		return Intent.make(this.action, this.owner, this.coll, this.filename, new URLSearchParams(this.query));
	}

	view()
	{
		return Intent.make("view", this.owner, this.coll, this.filename, new URLSearchParams(this.query));
	}

	api()
	{
		return Intent.make("api", this.owner, this.coll, this.filename, new URLSearchParams(this.query));
	}
