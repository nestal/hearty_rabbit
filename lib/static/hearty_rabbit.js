...
function add_coll(coll)
{
	...
	entry.querySelector("div.text-overlay-box span").textContent = (coll.length > 0 ? coll : "(default album)");
...
function main()
{
	...
	if (dir.elements)
	{
		document.getElementById("headline").textContent = "Album: " + dir.collection;
	...
	else
	{
		...
		console.log("form location is", document.getElementById("login-from").value);
