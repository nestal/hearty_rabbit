...
TEST_CASE("path URL")
{
	...
	REQUIRE(slash_upload_slash_path_slash_slash_filename.path() == "");
	...
	REQUIRE(slash_upload_slash_path_3slash_filename.path() == "");
	...
	REQUIRE(path_with_2slashes.path() == "something/////wrong");
